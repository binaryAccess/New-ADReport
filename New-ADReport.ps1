<#
  ...
  .NOTES
    ...
    - 1.28: $strGlobalCatalogServer detection changed for better PSdrive support
...
Function New-ADReport
{
  ...
  # Get current script execution directory (for output files) - TODO
  # $strScriptPath = Split-Path $MyInvocation.MyCommand.Definition -Parent
